...
public class SpaceGrid : MonoBehaviourPun {
    ...
    private void BoardSetup()     {         //INSTANTIATE WALLS         //north:0, east:1, south:2, west:3          Space currSpace;         GameObject w1 = GameObject.Find("/Board/Walls/1");
        ...
        d1.GetComponent<Door>().setPhysicalObject(d1);         GameObject d2 = GameObject.Find("/Board/Doors/Door top");
        d2.GetComponent<Door>().setPhysicalObject(d2);         GameObject d3 = GameObject.Find("/Board/Doors/Door bottom");
        d3.GetComponent<Door>().setPhysicalObject(d3);         GameObject d4 = GameObject.Find("/Board/Doors/Door right");
        d4.GetComponent<Door>().setPhysicalObject(d4);         GameObject d5 = GameObject.Find("/Board/Doors/Door left");
        d5.GetComponent<Door>().setPhysicalObject(d5);         GameObject d6 = GameObject.Find("/Board/Doors/doorCol78");
        d6.GetComponent<Door>().setPhysicalObject(d6);         GameObject d7 = GameObject.Find("/Board/Doors/doorCol56");
        d7.GetComponent<Door>().setPhysicalObject(d7);         GameObject d8 = GameObject.Find("/Board/Doors/doorCol67");
        d8.GetComponent<Door>().setPhysicalObject(d8);         GameObject d9 = GameObject.Find("/Board/Doors/doorRow56");
        d9.GetComponent<Door>().setPhysicalObject(d9);         GameObject d10 = GameObject.Find("/Board/Doors/doorCol89");
        d10.GetComponent<Door>().setPhysicalObject(d10);         GameObject d11 = GameObject.Find("/Board/Doors/doorRow34");
        d11.GetComponent<Door>().setPhysicalObject(d11);         GameObject d12 = GameObject.Find("/Board/Doors/doorCol34");
